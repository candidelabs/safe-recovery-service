...
describe('alerts otp bypass', ()=>{
    ...
    describe('alerts/subscribe', ()=>{
        ...
        it('should fail with 403 to register if invalid otp bypass token', async ()=>{
            ...
            .expect(403).then((response) => {
                expect(response.body.message).toContain(
                    "Invalid otp bypass authorization token"
                )
            });
        });

        it('should succeed with 200 to register if valid owner signature and correct otp bypass token', async ()=>{
            const chainId = 11155111;
    ...
    describe('alerts/activate', ()=>{
        ...
        it('should fail with 400 to activate with otp', async ()=>{
            await supertest(app).post('/v1/alerts/activate/')
            .send({
        ...
        it('should receive an email if a guardian initiated a recovery without otp verification', async ()=>{
